...
\begin{frame}{Analysing the Challenges using TRIZ}
  ...
  \begin{center}
    \includegraphics[width=.8\textwidth]{images/aA9bD9.png}
  \end{center}
\end{frame}
...
\begin{frame}{Analysing the Challenges using TRIZ}
  TRIZ rule -- model and go to extreme parameter values.
  \begin{center}
    \includegraphics[width=.45\textwidth]{images/RMZ1it.png}\hfill
    \includegraphics[width=.45\textwidth]{images/mP650q.png}
  \end{center}
\end{frame}
